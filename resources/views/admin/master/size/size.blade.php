            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-accent-theme">
                        <div class="card-body">
                            <h4 class="text-theme">Data Size Barang</h4>
                            <br/>
                    ...
                    success: function(response){
                        ...
                        console.log(len);
                            for(var i=0; i<len; i++){
                                ...
                                var jml = response['data'][i].jumlah_size;
                                var urlAdd = "{{ url('admin/master/size/add/') }}";
                                var urlView = "{{ url('admin/master/size/view/') }}";
                                ...
                                if(jml != 0){
                                    ...
                                    '<td>'+ nama +'</td>',
                                    '<td>'+ jml +'</td>',
                                    '<td><a href="'+ urlView +'/'+ id +'" id="update" class="btn btn-sm btn-success" data-id="'+ id +'">Lihat<i class="mdi mdi-eye"></i></a></td>'
                                    ]).draw(false);
                                } else {
                                    t.row.add([
                                    '<td>'+ nama +'</td>',
                                    '<td>'+ jml +'</td>',
                                    '<td><a href="'+ urlAdd +'/'+ id +'" id="update" class="btn btn-sm btn-primary" data-id="'+ id +'">Tambah<i class="mdi mdi-plus"></i></a></td>'
                                    ]).draw(false);
                                }
