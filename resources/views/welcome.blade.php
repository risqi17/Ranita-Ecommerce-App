        ...
        <header class="header_area animated">
            <div class="container-fluid">
                <div class="row text-center">
                    ...
                    <div class="col-12 col-lg-10">
                        <div class="menu_area">
                            <nav class="navbar navbar-expand-lg navbar-light" id="navbar-example2">
                                <!-- Logo -->
                                <a class="navbar-brand" href="#">rast.</a>
                                ...
                                <div class="collapse navbar-collapse" id="ca-navbar">
                                    <ul class="navbar-nav ml-auto" id="nav">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link scroll" href="#produk">Produk</a>
                                        </li>
                                        <li class="nav-item">
                                                <a class="nav-link scroll" href="#blog">Blog</a>
                                        </li>
                                        <li class="nav-item">
                                                <a class="nav-link scroll" href="#review">Review</a>
                                        </li>
                                        <li class="nav-item">
                                                <a class="nav-link scroll" href="#kategori">Kategori</a>
                                            </li>
                                        <li class="nav-item">
                                            <a class="nav-link scroll" href="#tentang">Tentang</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#pricing" class=" btn btn-round btn-outline-theme d-lg-none text-theme">Belanja</a>
                                        </li>
                                    </ul>
                    ...
                    <!-- Buy now btn -->
                    <div class="col-12 col-lg-2 buynow-btn">
                        <a href="#pricing" class="btn btn-round btn-outline-theme">
                            Belanja
                        </a>
                    </div>
                </div>
                ...
                <div class="row text-center">
                    <div class="col-12 col-md">
                        <div class="wellcome-heading">
                            <div class="">
                                <h1 class="text-white line-1 anim-typewriter">Lift Up Your style</h1>
                            </div>
                                <h1 class="text-white">We're Ready To Be Your Partner</h1>
                            <div class="h1 text-white">rast.</div>
                            <p>We Provide Product With Premium Quality</p>
                        </div>
                        <div class="get-start-area">
                            <a href="contents/dashboards/dashboard-sales.html" class="btn btn-round btn-outline-theme">Cek Produk</a>
                            <a href="contents/documentation/documentation.html" class="btn btn-round btn-theme">Cara Belanja</a>
                        </div>
                    </div>
                </div>
            </div>
